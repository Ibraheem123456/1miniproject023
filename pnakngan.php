...
<div class="container">
 <?php include("menu.php");?>
    <table id="mytable" class="table table-bordered table-striped"> 
        <h2 style="color: white;">ข้อมูลพนักงาน</h2>
<div class="mb-3">   
...
echo '<td style="color: white;">'. $row['E_Name'] . '</td>';
echo '<td style="color: white;">'. $row['E_Lastname'] . '</td>';
echo '<td style="color: white;">'. $row['E_Phone'] . '</td>';
echo '<td style="color: white;"><a role="button"  href="update4.php?E_Id='.$row['E_Id'].'" class="btn btn-primary">Update</a> ';  //ปุ่มที่เพิ่มเข้ามา
